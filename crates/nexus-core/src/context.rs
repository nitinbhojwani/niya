...
fn default_system_prompt() -> String {
    r#"You are Nexus, a coding assistant that helps developers by reading, writing, and editing files, running shell commands, and searching codebases. You have access to tools for interacting with the project.
...
mod tests {
    ...
    fn assemble_includes_system_prompt() {
        ...
        assert!(assembled.system.contains("Nexus"));
    }
